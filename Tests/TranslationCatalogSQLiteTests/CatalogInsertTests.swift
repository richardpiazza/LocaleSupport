...
final class CatalogInsertTests: _CatalogTestCase {
    ...
    static var allTests = [
        ("testInsertProject", testInsertProject),
        ("testInsertExpression", testInsertExpression),
        ("testInsertTranslation", testInsertTranslation),
        ("testInsertProject_CascadeExpressions", testInsertProject_CascadeExpressions),
        ("testInsertExpression_CascadeTranslations", testInsertExpression_CascadeTranslations),
    ]
